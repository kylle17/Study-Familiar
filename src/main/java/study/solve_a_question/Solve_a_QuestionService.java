...
import study.knowledge_manage.KnowledgeManageMapper;
...
public class Solve_a_QuestionService {
    ...
    public ArrayList<HashMap<String,String>> selectLevel1(){ return solve_a_questionMapper.selectLevel1(); }


    public ArrayList<HashMap<String,String>> selectLevel2(String level1){ return solve_a_questionMapper.selectLevel2(level1); }


    public ArrayList<HashMap<String,String>> selectCategorize_group(String level1 , String level2){ return solve_a_questionMapper.selectCategorize_group(level1,level2); }
